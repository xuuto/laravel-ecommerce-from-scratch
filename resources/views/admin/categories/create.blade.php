            ...
            <div class="tile">
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" role="form"
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save
                            Category
                        </button>
                        &nbsp;&nbsp;&nbsp;
...
@push('scripts')
    ...
    <script>
        $(function () {
            var galleryPlaceholder = "<i class='fa fa-search'></i>  " + "Select a Parent Category";
