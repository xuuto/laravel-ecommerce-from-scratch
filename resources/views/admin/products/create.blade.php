                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="categories[]" id="categories" class="form-control" multiple>
                                                @foreach($categories as $key => $category)
                                                    <option value="{{$key}}" {{ (collect(old('categories'))->contains
                                                    ($key)) ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                    </option>
                                                @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                    class="form-control @error('special_price') invalid-feedback
                                                    @enderror"
                                                    type="text"
                                            ...
                                            />
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i> @error('special_price')
                                                <span>{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success" type="submit"><i
                                                    class="fa fa-fw fa-lg fa-check-circle"></i>Save Product
                                        </button>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#categories').select2({
               placeholder: 'Select Single or Multiple categories',
               allowClear: true,
            });
