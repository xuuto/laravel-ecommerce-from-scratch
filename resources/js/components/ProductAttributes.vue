        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              >
                <option :value="attribute" v-for="attribute in attributes">
                  {{ attribute.name }}
                </option>
              </select>
            </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            >
              <option :value="value" v-for="value in attributeValues">
                {{ value.value }}
              </option>
            </select>
          </div>
...
export default {
  ...
  methods: {
    ...
    selectAttribute(attribute) {
      ...
      axios
        .post("/admin/products/attributes/values", {
          id: attribute.id,
        })
        .then(function (response) {
    ...
    addProductAttribute() {
      if (this.currentQty === null || this.currentPrice === null) {
        ...
        axios
          .post("/admin/products/attributes/add", {
            data: data,
          })
          .then(function (response) {
    ...
    deleteProductAttribute(pa) {
      ...
      this.$swal({
        ...
        if (willDelete) {
          console.log(pa.id);
          axios
            .post("/admin/products/attributes/delete", {
              id: pa.id,
            })
            .then(function (response) {
