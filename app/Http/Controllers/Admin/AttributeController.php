...
class AttributeController extends BaseController
{
    ...
    public function update(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        if (!$attribute) {
            return $this->responseRedirectBack('Error occurred while updating attribute.', 'error');
        }
    ...
    public function delete($id): \Illuminate\Http\RedirectResponse
    {
        ...
        if (!$attribute) {
            return $this->responseRedirectBack('Error occurred while deleting attribute.', 'error');
        }
